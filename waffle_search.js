 ...
 * @param {string} token
 */
export function pass_captcha_token(token) {
    const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.pass_captcha_token(ptr0, len0);
}
 ...
 * @param {any} response
 */
export function handle_jsrust_response(response) {
    wasm.handle_jsrust_response(response);
}

/**
 * @param {Function} cb
 */
export function set_jsrust_response_handler(cb) {
    wasm.set_jsrust_response_handler(cb);
}

/**
 * @param {any} session
 */
export function supabase_session(session) {
    wasm.supabase_session(session);
}

/**
 * @param {any} user
 */
export function supabase_user(user) {
    wasm.supabase_user(user);
}
...
function __wbg_adapter_61(arg0, arg1) {
    const ret = wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2a39f85608616f88_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper2484 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 682, __wbg_adapter_56);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper2488 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 682, __wbg_adapter_61);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper4333 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 1414, __wbg_adapter_64);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('waffle_search_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
